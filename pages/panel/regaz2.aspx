<%@ Page Language="C#" AutoEventWireup="true" CodeFile="regaz2.aspx.cs" Inherits="pages_panel_regaz2" %>
...
<section class="content">
    ...
    <div class="input-group input-group-sm">
     ...
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button2" runat="server" class="btn btn-dark fon" OnClick="Button2_Click"  Text="ثبت سوالات" />
    </div>
    <hr style="width:100%;border-top: 1px solid #808080;"/>
    <br />
