<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Register.aspx.cs" Inherits="pages_panel_Register" %>
  ...
  <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <!-- SEARCH FORM -->
      ...
      <div class="input-group input-group-sm">
          <asp:TextBox ID="TextBox1" class="form-control form-control-navbar fon cen" runat="server" placeholder="جستجو بر اساس کد ملی یا نام و نام خانوادگی"></asp:TextBox>
          &nbsp;
    ...
    <div class="sidebar" style="direction: ltr">
      <div style="direction: rtl">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="info">
            <a href="#" class="d-block">ثبت نام جدید</a>
          </div>
        </div>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark fon">مدیریت ثبت نام</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<section class="content">
          ...
          <div class="input-group input-group-sm">
          <asp:TextBox ID="TextBox2" class ="form-control btn-group ali fon rdx" placeholder="نام و نام خانوادگی" runat="server"></asp:TextBox>
               &nbsp;&nbsp;&nbsp;
          <asp:TextBox ID="TextBox3" class ="form-control btn-group ali fon rdx" placeholder="کد ملی" runat="server"></asp:TextBox>
               &nbsp;&nbsp;&nbsp;
           <asp:TextBox ID="TextBox4" class ="form-control btn-group ali fon rdx" placeholder="توضیحات" runat="server"></asp:TextBox>
               &nbsp;&nbsp;&nbsp;
              <input  name="AnotherDate2" class="form-control btn-group ali fon rdx"  placeholder="تاریخ ثبت" MaxLength="10"  onclick="displayDatePicker('AnotherDate2');">
               &nbsp;&nbsp;&nbsp;
              <asp:Button ID="Button2" runat="server" OnClick="Button3_Click" class="btn btn-danger fon"  Text="ثبت مشاور" />
              </div>
          <br />
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
  ...
  <asp:BoundField DataField="com" ItemStyle-CssClass="a12" HeaderStyle-HorizontalAlign="Center" HeaderText="توضیحات" >
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
