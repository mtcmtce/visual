<%@ Page Language="C#" AutoEventWireup="true" CodeFile="panel_techar.aspx.cs" Inherits="pages_panel_panel_techar" %>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      ...
      <span class="brand-text font-weight-light">پنل آموزگاران</span>
    </a>
    ...
    <div class="sidebar" style="direction: ltr">
      <div style="direction: rtl">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="info">
            <a href="#" class="d-block">آموزگار</a>
          </div>
        </div>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="../tec/elc.aspx" class="nav-link">
                    <i class="fa fa-circle-o nav-icon"></i>
                    <p>آزمون تشریحی</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="../tec/tak.aspx" class="nav-link">
                    <i class="fa fa-circle-o nav-icon"></i>
                    <p>تکالیف</p>
                  </a>
                </li>
               <li class="nav-item">
                  <a href="../tec/good.aspx" class="nav-link">
                    <i class="fa fa-circle-o nav-icon"></i>
                    <p>محتوای الکترونیکی</p>
                  </a>
                </li>

             <li class="nav-item">
                  <a href="../../msg_tec.aspx" class="nav-link">
                    <i class="fa fa-circle-o nav-icon"></i>
                ...
                <li class="nav-item">
                  <a href="../forms/connect.aspx" class="nav-link">
                    <i class="fa fa-circle-o nav-icon"></i>
                    <p>ارتباط با مشاور</p>
                  </a>
                </li>
     ...
     <li class="nav-item">
         <a href="https://farapayamak.ir/login/" class="nav-link">
              <i class="fa fa-circle-o nav-icon"></i>
          <p>پنل اسمس</p>
           </a>
       </li>
