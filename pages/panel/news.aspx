<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="news.aspx.cs" Inherits="pages_panel_news" %>
  ...
  <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <ul class="navbar-nav">
      ...
      <div class="input-group input-group-sm">
          <asp:TextBox ID="TextBox1" class="form-control form-control-navbar fon cen" runat="server" placeholder="جستجو بر اساس عنوان یا تاریخ"></asp:TextBox>
          &nbsp;
        <div class="input-group-append">
            <asp:Button ID="Button1" class="btn btn-primary active" OnClick="Button1_Click" runat="server" Text="جستجو"/>
        </div>
      </div>
    ...
    <div class="sidebar" style="direction: ltr">
      <div style="direction: rtl">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="info">
            <a href="#" class="d-block">مدیریت خبر</a>
          </div>
        </div>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark fon">مدیریت خبر ها</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<section class="content">
    ...
    <div class="input-group input-group-sm">
            <asp:TextBox ID="TextBox3" class="form-control btn-group fon cen rdx" placeholder="عنوان خبر" runat="server"></asp:TextBox>
            &nbsp;&nbsp;&nbsp;
            <input  name="AnotherDate2" class="form-control btn-group ali fon rdx"  placeholder="انتخاب تاریخ" MaxLength="10"  onclick="displayDatePicker('AnotherDate2');">
            &nbsp;&nbsp;&nbsp;
             <div class="input-group-append">
      <asp:Button ID="Button2" class="btn btn-danger rdx" runat="server" OnClick="Button2_Click"  Text="ثبت خبر"/>
        </div>
            <hr style="width:100%;border-top: 1px solid red;" />
            <asp:TextBox ID="TextBox2" class="form-control btn-group fon rdx" TextMode="MultiLine" Width="100%" Height="200px" placeholder="شرح خبر" runat="server"></asp:TextBox>
    ...
    AutoGenerateColumns="False">
        ...
        <asp:BoundField DataField="onvan" ItemStyle-CssClass="a12" HeaderStyle-HorizontalAlign="Center" HeaderText="عنوان خبر">
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>

<ItemStyle ></ItemStyle>
                    </asp:BoundField>
        <asp:BoundField DataField="descs" ItemStyle-CssClass="a12" HeaderStyle-HorizontalAlign="Center" HeaderText="شرح خبر" >
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>

                    </asp:BoundField>

    <asp:BoundField DataField="dat" ItemStyle-CssClass="a12" HeaderStyle-HorizontalAlign="Center" HeaderText="تاریخ خبر" >
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
      ...
      <asp:TemplateField ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="Red">
                <ItemTemplate>
                    <asp:LinkButton ID="lnkdeletet"  runat="server" OnClick="lnkdeletet_Click"  CommandArgument='<%# Eval("Id") %>'>حذف</asp:LinkButton>
                </ItemTemplate>
