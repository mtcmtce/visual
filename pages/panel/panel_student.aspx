<%@ Page Language="C#" AutoEventWireup="true" CodeFile="panel_student.aspx.cs" Inherits="student_panel_student" %>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      ...
      <span class="brand-text font-weight-light">پنل دانش آموزی</span>
    </a>
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="info">
            <div class="fon" style="color:#ffffff">
                <h6>نام : <asp:Label ID="Label3" runat="server" Text="نام و نام خانوادگی:"></asp:Label></h6>
                <h6>کد ملی : <asp:Label ID="Label1" runat="server" Text="ک ملی"></asp:Label></h6>
              <h6>پایه تحصیلی : <asp:Label ID="Label2" CssClass="fon cole" runat="server" Text=""></asp:Label></h6></a>
          </div>
        </div>
          </div>
        <!-- Sidebar Menu -->
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="../../student/onlineaz.aspx" class="nav-link">
             ...
             <li class="nav-item">
              ...
              <li class="nav-item">
                  <a href="../../student/froo.aspx" class="nav-link">
                    <i class="fa fa-circle-o nav-icon"></i>
                    <p>خرید آزمون</p>
                  </a>
                </li>
