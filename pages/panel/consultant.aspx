<%@ Page Language="C#" AutoEventWireup="true" CodeFile="consultant.aspx.cs" Inherits="pages_panel_consultant" %>
    ...
    <div class="sidebar" style="direction: ltr">
      <div style="direction: rtl">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="info">
            <a href="#" class="d-block">ارتباط با مشاور</a>
          </div>
        </div>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark fon">ارتباط مشاور</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<section class="content">
       ...
       <div class="input-group input-group-sm">
          ...
          <asp:TextBox ID="TextBox3" class ="form-control btn-group ali fon rdx" placeholder="شرح پیام" runat="server"></asp:TextBox>
               &nbsp;&nbsp;&nbsp;
           <asp:Button ID="Button2" CssClass="btn btn-danger fon" OnClick="Button2_Click" runat="server" Text="ثبت پیام" />
              </div>
    <br />
           <div class="input-group input-group-sm">
           <input  name="AnotherDate2" class="form-control btn-group ali fon rdx"  placeholder="تاریخ ثبت" MaxLength="10"  onclick="displayDatePicker('AnotherDate2');">
              &nbsp;&nbsp;&nbsp;
          <asp:TextBox ID="TextBox4" class ="form-control btn-group ali fon rdx" placeholder="پایه" runat="server"></asp:TextBox>
              </div>
    <br />
