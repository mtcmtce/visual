   ...
   <div class="container register">
                <div class="row">
                    <div class="col-md-3 register-left">
                        ...
                        <p style="font-family:'B Yekan'">نکته:کاربرگرامی یش ثبت نام شما به منزله ثبت نام قطعی تلقی نخواهد شد</p>
                        
                        <!-- Button Hide -->
                        <asp:Button ID="Button1" CssClass="btn-warning fon wit"  runat="server" Text="پیگیری ثبت نام" OnClick="reg"/>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row register-form" style="font-family:'B Yekan';text-align:center">
                                        ...
                                        <div class="form-group">
                                            <input  name="AnotherDate2" class="form-control ali" placeholder="تاریخ تولد روز-ماه-سال" MaxLength="10" TabIndex="6" onclick="displayDatePicker('AnotherDate2');">
                                        </div>
                             <div class="form-group">
                                 <asp:TextBox ID="TextBox8" runat="server" class="form-control ali" onkeypress="return isNumberKey(event)" placeholder="نام پدر" MaxLength="30" TabIndex="5"></asp:TextBox>
                                    ...
                                    <div class="col-md-6">
                                    <div class="form-group">
                                              <asp:TextBox ID="TextBox7" runat="server" class="form-control ali" onkeypress="return isNumberKey(event)" placeholder="محل صدور" MaxLength="30" TabIndex="0"></asp:TextBox>
                                        </div>
