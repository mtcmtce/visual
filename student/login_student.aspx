<%@ Page Language="C#" AutoEventWireup="true" CodeFile="login_student.aspx.cs" Inherits="student_login_student" %>
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>پنل کاربری دانش آموزان</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    ...
    <asp:TextBox ID="TextBox2" runat="server" class="form-control" placeholder="رمز عبور" MaxLength="15" TextMode="Password"></asp:TextBox>
        ...
        <div class="row">
          ...
          <asp:Button ID="Button1" runat="server" Text="ورود" class="btn btn-primary btn-block btn-flat cen" OnClick="btn_Click" />
            </div>
          </div>
          <!-- /.col -->
          <div class="col-4">
