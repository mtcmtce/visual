<%@ Page Language="C#" AutoEventWireup="true" CodeFile="nom.aspx.cs" Inherits="student_nom" %>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      ...
      <span class="brand-text font-weight-light">دانش آموز</span>
    </a>
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
         ...
         <asp:BoundField DataField="nom" ItemStyle-CssClass="a12" HeaderStyle-HorizontalAlign="Center" HeaderText="نمره" >
            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
               </asp:BoundField>
